...
def run_training(params, save_model = False):
    ...
    model = models.MLP_MLE(model_params)
    print(model)
    ...
    for epoch in range(no_of_epochs):
        ...
        if val_loss < best_loss:
            best_loss = val_loss
            if save_model:
                torch.save(model.state_dict(), '/home/rajeckidoyle/Documents/Classification/BACE_Classification/regressionandunccertainty/hyperparameter_files/best_models/mlp_mle_model.pt')
        else:
...
if __name__ == '__main__':
    ...
    best_parameters.to_csv('/home/rajeckidoyle/Documents/Classification/BACE_Classification/regressionandunccertainty/hyperparameter_files/best_models/mlp_mle_best_parameters.csv')