...
def run_training(params, save_model = False):
    ...
    for epoch in range(no_of_epochs):
        ...
        if val_loss < best_loss:
            best_loss = val_loss
            if save_model:
                torch.save(model.state_dict(), '/home/rajeckidoyle/Documents/Classification/BACE_Classification/regressionandunccertainty/hyperparameter_files/best_models/mlp_qr_model.pt')
        else:
...
if __name__ == '__main__':
    ...
    best_parameters.to_csv('/home/rajeckidoyle/Documents/Classification/BACE_Classification/regressionandunccertainty/hyperparameter_files/best_models/mlp_qr_best_parameters.csv')