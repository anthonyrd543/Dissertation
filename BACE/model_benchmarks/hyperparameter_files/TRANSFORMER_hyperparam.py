...
def run_training(params, save_model = False):
    ...
    model = models.TRANSFORMER(model_params)
    print(model)
    ...
    for epoch in range(no_of_epochs):
        ...
        if val_loss < best_loss:
            best_loss = val_loss
            if save_model:
                torch.save(model.state_dict(), '/home/rajeckidoyle/Documents/Classification/BACE_Classification/model_benchmarks/hyperparameter_files/saved_models/transformer_model.pt')
        else:
...
def objective(trial):
    params = {
        ...
        "model_transformer_dropout_rate":  trial.suggest_uniform('model_transformer_dropout_rate', 0.01, 0.2),
...
if __name__ == '__main__':
    ...
    study.optimize(objective, n_trials=n_iters, gc_after_trial=True)
    ...
    best_parameters.to_csv('/home/rajeckidoyle/Documents/Classification/BACE_Classification/model_benchmarks/hyperparameter_files/best_parameters/transformer_best_parameters.csv')
