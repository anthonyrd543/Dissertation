...
def run_training(params, save_model = False):
    ...
    model = models.GATv2(model_params)
    print(model)
    ...
    for epoch in range(no_of_epochs):
        ...
        if val_loss < best_loss:
            best_loss = val_loss
            if save_model:
                torch.save(model.state_dict(), '/home/rajeckidoyle/Documents/Classification/BACE_Classification/model_benchmarks/hyperparameter_files/saved_models/gatv2_model_short.pt')
        else:
...
if __name__ == '__main__':
    ...
    best_parameters.to_csv('/home/rajeckidoyle/Documents/Classification/BACE_Classification/model_benchmarks/hyperparameter_files/best_parameters/gatv2_best_parameters_short.csv')